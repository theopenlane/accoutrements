...
import (
	...
	"github.com/theopenlane/accoutrements/config-generation/config"
	"github.com/theopenlane/accoutrements/config-generation/envparse"
)
...
func generateSchema(c schemaConfig, structure interface{}) error {
	...
	for _, pkg := range includedPackages {
		if err := r.AddGoComments("github.com/theopenlane/accoutrements/", pkg); err != nil {
			panic(err.Error())
		}
	}
